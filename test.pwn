...
public OnPlayerSpawn(playerid) {
    ...
    SendClientMessage(playerid, 0xFF0000FF, "/setmax <number> {FFFFFF}to change the maximum value of the 3D progress bar.");
...
CMD:bar(playerid, params[]) {
    ...
    Bar = CreateProgressBar3D(0xFF0000FF, 0xFFFFFFFF, 100.0, 50.0, pos[0], pos[1], pos[2], 100.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, -1, -1, -1, STREAMER_3D_TEXT_LABEL_SD, -1);
    return 1;
}
