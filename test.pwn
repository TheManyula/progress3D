...
public OnPlayerSpawn(playerid) {
    ...
    SendClientMessage(playerid, 0xFF0000FF, "/(p)hide {FFFFFF}to hide the 3D progress bar.");
    SendClientMessage(playerid, 0xFF0000FF, "/(p)show {FFFFFF}to show the 3D progress bar.");
